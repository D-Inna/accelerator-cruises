...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_burger_menu__WEBPACK_IMPORTED_MODULE_3__["burgerMenu"])();
...
var burgerMenu = function burgerMenu() {
  var iconHeader = document.querySelector('[data-burger]');
  var navHeader = document.querySelector('[data-nav]');
  var imageHeader = document.querySelector('[data-image]');
  if (iconHeader) {
